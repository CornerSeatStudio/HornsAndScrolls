                ...
                .EmplaceSelector("main selector")
                    ...
                    .EmplaceSequencer("Combat Sequence")
                        ...
                        .EmplaceSelector("combat Selection") 
                            .EmplaceSequencer("Pivot to Aggro Sequence")
                                .EmplaceConditional("pivot conditional", t => ai.PivotConditional())
                                .EmplaceTask("pivot", t => ai.PivotTask())
                                .PopDepth()
                            ...
                            //     .PopDepth()
                            .EmplaceSequencer("circling sequencer")
                                .EmplaceConditional("circling conditional", t => ai.CirclingConditional())
                                .EmplaceTask("circling task", t => ai.CirclingTask())
                                .PopDepth()
